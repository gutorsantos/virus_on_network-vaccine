...
def network_portrayal(G):
    ...
    def node_color(agent):
        return {State.INFECTED: "#FF0000", State.SUSCEPTIBLE: "#008000", State.SUSCEPTIBLE_AND_VACCINATED: "#0000FF"}.get(
            agent.state, "#808080"
        )
...
chart = ChartModule(
    [
        ...
        {"Label": "Susceptible and Vaccinated", "Color": "#0000FF"},
    ]
)
...
model_params = {
    ...
    "num_vaccinated": UserSettableParameter(
        "slider",
        ...
        1,
        0.1,
        description="Initial Vaccinated Size",
    ),
    "vaccine_rate": UserSettableParameter(
        "slider",
        ...
        1,
        0.01,
        description="Vaccine protection rate",
    )
}
